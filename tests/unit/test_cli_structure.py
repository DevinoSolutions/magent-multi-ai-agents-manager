...
class TestAttachFlowCharacterization:
    ...
    def test_psmux_path_spawns_and_tiles(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(
            "magent.cli.attach._maybe_start_hotkey",
            lambda url, ssh_host=None: 1234,
        )
