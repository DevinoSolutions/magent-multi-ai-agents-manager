...
Each magent session brands its psmux status bar — `magent` on the left, its window hotkeys on the right (`F1 Proj. Picker   F2 </> VS Code`, each key name badged in bold cyan):
